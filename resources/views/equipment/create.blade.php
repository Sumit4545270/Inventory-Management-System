                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('equipment.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="warranty_expiry_date" name="warranty_expiry_date" type="date" class="mt-1 block w-full" :value="old('warranty_expiry_date')" />
                        ...
                        <div>
                            ...
                            <x-text-input id="model_number" name="model_number" type="text" class="mt-1 block w-full" :value="old('model_number')" />
