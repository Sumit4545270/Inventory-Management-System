...
<body class="index-body login">
		...
		<div class="container-fluid">
			...
			<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#sidebar-collapse" aria-expanded="false" aria-controls="sidebar-collapse">
			...
			<a class="navbar-brand" href="#">
				<img src="http://www.gfgcoe.in/wp-content/uploads/2023/02/GC-logo-white.png" alt="College Logo" style="height:30px; display:inline-block; margin-right:10px; vertical-align:middle;">
